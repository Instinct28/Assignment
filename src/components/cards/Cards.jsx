...
function Cards() {
  ...
  return(
    ...
    <Row>
  <Col xs="6" sm="4">
    <Card style={{ marginTop: '20px', width: "250px",borderRadius: "5px", height: "100px", backgroundColor: 'white' }}>
      <CardBody>
  ...
  <Col xs="6" sm="4">
    <Card style={{marginTop: '20px', width: "350px", height: "100px", backgroundColor: 'white' }}>
      <CardBody style={{alignItems:"right"}}>
        <Button style={{ width: "20px", height: "20px", borderRadius: "30px", backgroundColor: 'white', borderColor: 'white', Shadow: "5px" }}>
